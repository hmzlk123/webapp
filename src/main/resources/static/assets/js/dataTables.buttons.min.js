...
function(a) {
    ...
    a.extend(i.prototype, {
        ...
        add: function(a, b) {
            ...
            return this.dom.container.empty(),
        ...
        disable: function(a) {
            ...
            return b.node.addClass(this.c.dom.button.disabled),
            this
        },
        destroy: function() {
        ...
        enable: function(a, b) {
            ...
            var c = this._indexToButton(a);
            return c.node.removeClass(this.c.dom.button.disabled),
            this
        },
        name: function() {
            return this.c.name
        ...
        _constructor: function() {
            ...
            a("body").on("keyup." + this.s.namespace,
            function(a) {
        ...
        _buildButtons: function(b, c, e) {
            ...
            i = b.length; i > h; h++) {
                ...
                if (j) if (a.isArray(j)) this._buildButtons(j, c, e);
                else {
                    ...
                    if (k) {
                        ...
                        j.init && j.init.call(f.button(l), f, l, j),
                        g++
                    }
                }
            }
        ...
        _buildButton: function(b, c) {
            ...
            var j = function(b, c, d, e) {
                ...
                a(c.table().node()).triggerHandler("buttons-action.dt", [c.button(d), c, d, e])
            },
            k = a("<" + d.tag + "/>").addClass(d.className).attr("tabindex", this.s.dt.settings()[0].iTabIndex).attr("aria-controls", this.s.dt.table().node().id).on("click.dtb",
            function(a) {
                a.preventDefault(),
            ...
            e.tag ? k.append(a("<" + e.tag + "/>").html(i(b.text)).addClass(e.className)) : k.html(i(b.text)),
            ...
            return l = m && m.tag ? a("<" + m.tag + "/>").addClass(m.className).append(k) : k,
            this._addKey(b),
            {
                node: k,
                inserter: l
    ...
    i.background = function(b, c, e) {
        e === d && (e = 400),
        b ? a("<div/>").addClass(c).css("display", "none").appendTo("body").fadeIn(e) : a("body > div." + c).fadeOut(e,
        function() {
            a(this).remove()
        })
    },
    i.instanceSelector = function(b, c) {
        ...
        f = function(b) {
            ...
            h = b.length; h > g; g++) f(b[g]);
            else if ("string" == typeof b) if ( - 1 !== b.indexOf(",")) f(b.split(","));
            else {
    ...
    i.buttonSelector = function(b, c) {
        for (var e = [], f = function(b, c) {
            ...
            else if (null === b || b === d || "*" === b) for (g = 0, h = i.length; h > g; g++) e.push({
                inst: c,
    ...
    a.extend(h, {
        collection: {
            ...
            action: function(d, e, f, g) {
                ...
                setTimeout(function() {
                    a("div.dt-button-background").on("click.dtb-collection",
                    function() {}),
                    a("body").on("click.dtb-collection",
                    function(b) {
                        a(b.target).parents().andSelf().filter(g._collection).length || (g._collection.fadeOut(g.fade,
                        function() {
                ...
                10),
                g.autoClose && e.on("buttons-action.b-internal",
                function() {
    ...
    function(a, b) {
        ...
        return c.length > 1 && c.splice(1, c.length),
        c
    }),
    e.Api.registerPlural("buttons().active()", "button().active()",
    function(a) {
    ...
    e.Api.registerPlural("buttons().action()", "button().action()",
    function(a) {
        return a === d ? this.map(function(a) {
    ...
    e.Api.register(["buttons().enable()", "button().enable()"],
    function(a) {
        return this.each(function(b) {
            b.inst.enable(b.idx, a)
        })
    }),
    e.Api.register(["buttons().disable()", "button().disable()"],
    function() {
        return this.each(function(a) {
            a.inst.disable(a.idx)
        })
    }),
    e.Api.registerPlural("buttons().nodes()", "button().node()",
    function() {
        var b = a();
    ...
    e.Api.registerPlural("buttons().text()", "button().text()",
    function(a) {
        return a === d ? this.map(function(a) {
    ...
    e.Api.registerPlural("buttons().trigger()", "button().trigger()",
    function() {
        return this.each(function(a) {
            a.inst.node(a.idx).trigger("click")
        })
    }),
    e.Api.registerPlural("buttons().containers()", "buttons().container()",
    function() {
        var b = a();
        return a(this.each(function(a) {
    ...
    e.Api.register("button().add()",
    function(a, b) {
        return 1 === this.length && this[0].inst.add(a, b),
        this.button(a)
    }),
    e.Api.register("buttons().destroy()",
    function(a) {
    ...
    e.Api.registerPlural("buttons().remove()", "buttons().remove()",
    function() {
        return this.each(function(a) {
    ...
    e.Api.register("buttons.exportData()",
    function(a) {
    ...
    l = function(b, c) {
        ...
        f = b.columns(d.columns).indexes().map(function(a, c) {
            ...
            for (var q = new Array(j), r = 0; j > r; r++) q[r] = d.format.body(i[n], r, o),
            n++;
            m[o] = q
        }
        return {
    ...
    return a.fn.dataTable.Buttons = i,
    a.fn.DataTable.Buttons = i,
    a(c).on("init.dt plugin-init.dt",
    function(a, b, c) {
        if ("dt" === a.namespace) {
